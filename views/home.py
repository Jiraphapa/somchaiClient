...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.todo_button = QtWidgets.QPushButton(Form)
        ...
        self.reserve_button = QtWidgets.QPushButton(Form)
        ...
        self.todo_label = QtWidgets.QLabel(Form)
        ...
        # self.background_out = QtWidgets.QLabel(Form)
