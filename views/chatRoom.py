...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.onlineList.setStyleSheet("background-color:#23252c;color:white;font-size:18px;")
        ...
        self.messageList.setStyleSheet("background-color:#23252c;color:white;font-size:18px;")
        ...
        self.online_label.setStyleSheet("color:#0b2735;")
        self.contact_label.setStyleSheet("color:##0b2735;")
